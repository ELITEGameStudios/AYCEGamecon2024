...
{
    public bool kills, breakWithPlayer;
    [SerializeField] private GameObject effect;
    [SerializeField] private EnvironmentalSound envSound;

    void OnCollisionEnter2D(Collision2D col){
        if(col.collider == Player.main.MainCol && breakWithPlayer){
            BreakBox();
        } 
    }
    ...
    public void BreakBox(){
        ...
        EnvironmentalSoundSystem.instance.CreateEnvSound("WoodBoxBreak", envSound);
        Destroy(gameObject);    
    }
}
